...
<body class="bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-white mb-2">Booking System</h1>
            <p class="text-blue-100">Wujudkan liburan impian Anda</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm">Login untuk melanjutkan booking</p>
            </div>
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('home') }}" class="text-white hover:text-blue-100 text-sm font-medium hover:underline">
                ← Kembali ke beranda
            </a>
        </div>
    </div>
